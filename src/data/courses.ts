...
export const sampleCourses: Course[] = [
  {
    ...
    route: hakoneRoute,
    landmarks: [
      { name: '小田原料金所', progress: .06, type: 'ic' },
      { name: '御所入駐車場', progress: .43, type: 'viewpoint' },
      { name: '大観山', progress: .94, type: 'viewpoint' },
    ],
    distanceKm: 14.2,
    durationMin: 24,
    minElevation: 85,
  ...
  },
  {
    ...
    route: ashinokoRoute,
    landmarks: [
      { name: '箱根峠', progress: .08, type: 'ic' },
      { name: '三国峠', progress: .5, type: 'viewpoint' },
      { name: '湖尻峠', progress: .92, type: 'ic' },
    ],
  ...
  },
  {
    ...
    route: izuRoute,
    landmarks: [
      { name: '熱海峠IC', progress: .04, type: 'ic' },
      { name: '玄岳IC', progress: .27, type: 'ic' },
      { name: '冷川IC', progress: .62, type: 'ic' },
      { name: '天城高原IC', progress: .94, type: 'ic' },
    ],
  ...
  },
  {
    ...
    route: okutamaRoute,
    landmarks: [
      { name: '川野', progress: .06, type: 'place' },
      { name: '月夜見第二駐車場', progress: .5, type: 'viewpoint' },
      { name: '都民の森', progress: .93, type: 'place' },
    ],
